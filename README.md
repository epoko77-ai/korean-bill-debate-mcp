...
> **처리상태는 현재를 보여줍니다. 소위원회 회의록과 전문위원 검토보고서는 다음 흐름의
> 단서를 보여줍니다.**
>
> 국회 경험이 있어야 먼저 찾게 되는 두 자료를, 누구나 질문 한 줄로 확인할 수 있게.
> 누가 어떤 조문을 밀고 막았는지, 전문위원은 무엇을 지적했고 정부는 어떻게 답했는지까지
> 열린국회 공식 원문으로 연결합니다.
...
법안의 `처리상태`는 현재 위치만 알려줍니다. 향후 흐름을 판단하려면 국회 심사 과정에서
실제로 쓰이는 두 자료를 함께 봐야 합니다.
